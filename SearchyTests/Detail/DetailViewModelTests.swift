...
class DetailViewModelTests: XCTestCase {
  func testFetchContentDetailHandler() {
    ...
    let mockDetailModel = DetailModel(title: mockTitleLabelText, year: nil, rated: nil, released: mockReleaseDateLabelText, runtime: nil, genre: mockGenreLabelText, director: nil, writer: nil, actors: nil, plot: mockSummaryLabelText, language: nil, country: nil, awards: nil, poster: nil, ratings: nil, metascore: "Test Metascore", imdbRating: "Test Rating", imdbVotes: "Test Votes", imdbId: "Test ID", type: nil, boxOffice: nil, production: nil, website: nil, response: nil)
